...
module.exports = function ToReceiveIncomingSailsIOMsg(app) {
  ...
  return function receiveIncomingSailsIOMsg(options) {
    ...
    var requestContext = {
      ...
      body    : (! _.isArray(options.incomingSailsIOMsg.data)) ? _.extend({}, options.incomingSailsIOMsg.params || {}, options.incomingSailsIOMsg.data || {}) : options.incomingSailsIOMsg.data,
